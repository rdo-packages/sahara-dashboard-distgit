...
do
  ...
  ln -s %{_datadir}/openstack-dashboard/openstack_dashboard/local/enabled/${f}o \
        %{buildroot}%{_sysconfdir}/openstack-dashboard/enabled/${f}o
  ln -s %{_datadir}/openstack-dashboard/openstack_dashboard/local/enabled/${f}c \
        %{buildroot}%{_sysconfdir}/openstack-dashboard/enabled/${f}c
done
popd
